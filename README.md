...
This is a Resturant Page with a Home page/ Menu page/ Contact page

The goal for this project was to use Webpack to create a muilipage site,
while also using the DOM to create all of the HTML elements.
